...
\begin{enumerate}\setcounter{enumi}{295}
	...
	\item $2x-y-12z-3=0$, $3x+y-7z-2=0$ tekisliklarning kesishishidan hosil bo`lgan to`g`ri chiziq orqali o`tuvchi, $x+2y+5z-1=0$ tekislikka perpendikulyar bo`lgan tekislik tenglamasini toping.
